...
queries through the production Prisma client and checks the photo-offer namespace the
Atlas chain applies, against disposable PostgreSQL. The fixture uses
`@animichi/test-postgres` and the unchanged Atlas chain. Coordinate the Docker slot.
