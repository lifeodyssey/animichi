// Test double for the Turnstile gate — lives in test/doubles/ beside its
// consumers (see 2026-08-06-edge-gateway-structure-design.md §3).
import { TURNSTILE_HEADER, type TurnstileGate, type TurnstileResult, createTurnstileGate, guardTurnstile } from "../../src/protect/turnstile.ts";
