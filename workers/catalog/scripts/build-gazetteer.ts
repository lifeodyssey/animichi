...
export interface Prefecture { jis: string; name: string; en: string; capital: string; lat: number; lng: number; admin1: string }
...
interface CliOptions { stations: string; cities: string; outSql: string; outAudit: string }
type CityColumns = string[] & { 0: string; 1: string; 4: string; 5: string };
export const PREFECTURES: readonly Prefecture[] = [
  { jis: "01", name: "北海道", en: "Hokkaido", capital: "札幌市", lat: 43.0642, lng: 141.3469, admin1: "12" },
  { jis: "02", name: "青森県", en: "Aomori", capital: "青森市", lat: 40.8244, lng: 140.74, admin1: "03" },
  { jis: "03", name: "岩手県", en: "Iwate", capital: "盛岡市", lat: 39.7036, lng: 141.1527, admin1: "16" },
  { jis: "04", name: "宮城県", en: "Miyagi", capital: "仙台市", lat: 38.2688, lng: 140.8721, admin1: "24" },
  { jis: "05", name: "秋田県", en: "Akita", capital: "秋田市", lat: 39.7186, lng: 140.1024, admin1: "02" },
  { jis: "06", name: "山形県", en: "Yamagata", capital: "山形市", lat: 38.2404, lng: 140.3633, admin1: "44" },
  { jis: "07", name: "福島県", en: "Fukushima", capital: "福島市", lat: 37.7503, lng: 140.4676, admin1: "08" },
  { jis: "08", name: "茨城県", en: "Ibaraki", capital: "水戸市", lat: 36.3418, lng: 140.4468, admin1: "14" },
  { jis: "09", name: "栃木県", en: "Tochigi", capital: "宇都宮市", lat: 36.5657, lng: 139.8836, admin1: "38" },
  { jis: "10", name: "群馬県", en: "Gunma", capital: "前橋市", lat: 36.3912, lng: 139.0609, admin1: "10" },
  { jis: "11", name: "埼玉県", en: "Saitama", capital: "さいたま市", lat: 35.8569, lng: 139.6489, admin1: "34" },
  { jis: "12", name: "千葉県", en: "Chiba", capital: "千葉市", lat: 35.6047, lng: 140.1233, admin1: "04" },
  { jis: "13", name: "東京都", en: "Tokyo", capital: "東京", lat: 35.6895, lng: 139.6917, admin1: "40" },
  { jis: "14", name: "神奈川県", en: "Kanagawa", capital: "横浜市", lat: 35.4478, lng: 139.6425, admin1: "19" },
  { jis: "15", name: "新潟県", en: "Niigata", capital: "新潟市", lat: 37.9026, lng: 139.0236, admin1: "29" },
  { jis: "16", name: "富山県", en: "Toyama", capital: "富山市", lat: 36.6953, lng: 137.2113, admin1: "42" },
  { jis: "17", name: "石川県", en: "Ishikawa", capital: "金沢市", lat: 36.5947, lng: 136.6256, admin1: "15" },
  { jis: "18", name: "福井県", en: "Fukui", capital: "福井市", lat: 36.0652, lng: 136.2216, admin1: "06" },
  { jis: "19", name: "山梨県", en: "Yamanashi", capital: "甲府市", lat: 35.6642, lng: 138.5684, admin1: "46" },
  { jis: "20", name: "長野県", en: "Nagano", capital: "長野市", lat: 36.6513, lng: 138.181, admin1: "27" },
  { jis: "21", name: "岐阜県", en: "Gifu", capital: "岐阜市", lat: 35.3912, lng: 136.7223, admin1: "09" },
  { jis: "22", name: "静岡県", en: "Shizuoka", capital: "静岡市", lat: 34.9769, lng: 138.3831, admin1: "37" },
  { jis: "23", name: "愛知県", en: "Aichi", capital: "名古屋市", lat: 35.1802, lng: 136.9066, admin1: "01" },
  { jis: "24", name: "三重県", en: "Mie", capital: "津市", lat: 34.7303, lng: 136.5086, admin1: "23" },
  { jis: "25", name: "滋賀県", en: "Shiga", capital: "大津市", lat: 35.0045, lng: 135.8686, admin1: "35" },
  { jis: "26", name: "京都府", en: "Kyoto", capital: "京都市", lat: 35.0214, lng: 135.7556, admin1: "22" },
  { jis: "27", name: "大阪府", en: "Osaka", capital: "大阪市", lat: 34.6863, lng: 135.52, admin1: "32" },
  { jis: "28", name: "兵庫県", en: "Hyogo", capital: "神戸市", lat: 34.6913, lng: 135.183, admin1: "13" },
  { jis: "29", name: "奈良県", en: "Nara", capital: "奈良市", lat: 34.6853, lng: 135.8327, admin1: "28" },
  { jis: "30", name: "和歌山県", en: "Wakayama", capital: "和歌山市", lat: 34.226, lng: 135.1675, admin1: "43" },
  { jis: "31", name: "鳥取県", en: "Tottori", capital: "鳥取市", lat: 35.5039, lng: 134.2383, admin1: "41" },
  { jis: "32", name: "島根県", en: "Shimane", capital: "松江市", lat: 35.4723, lng: 133.0505, admin1: "36" },
  { jis: "33", name: "岡山県", en: "Okayama", capital: "岡山市", lat: 34.6618, lng: 133.935, admin1: "31" },
  { jis: "34", name: "広島県", en: "Hiroshima", capital: "広島市", lat: 34.3966, lng: 132.4596, admin1: "11" },
  { jis: "35", name: "山口県", en: "Yamaguchi", capital: "山口市", lat: 34.1861, lng: 131.4705, admin1: "45" },
  { jis: "36", name: "徳島県", en: "Tokushima", capital: "徳島市", lat: 34.0658, lng: 134.5593, admin1: "39" },
  { jis: "37", name: "香川県", en: "Kagawa", capital: "高松市", lat: 34.3401, lng: 134.0434, admin1: "17" },
  { jis: "38", name: "愛媛県", en: "Ehime", capital: "松山市", lat: 33.8417, lng: 132.7661, admin1: "05" },
  { jis: "39", name: "高知県", en: "Kochi", capital: "高知市", lat: 33.5597, lng: 133.5311, admin1: "20" },
  { jis: "40", name: "福岡県", en: "Fukuoka", capital: "福岡市", lat: 33.6064, lng: 130.4183, admin1: "07" },
  { jis: "41", name: "佐賀県", en: "Saga", capital: "佐賀市", lat: 33.2494, lng: 130.2988, admin1: "33" },
  { jis: "42", name: "長崎県", en: "Nagasaki", capital: "長崎市", lat: 32.7448, lng: 129.8737, admin1: "26" },
  { jis: "43", name: "熊本県", en: "Kumamoto", capital: "熊本市", lat: 32.7898, lng: 130.7417, admin1: "21" },
  { jis: "44", name: "大分県", en: "Oita", capital: "大分市", lat: 33.2382, lng: 131.6126, admin1: "30" },
  { jis: "45", name: "宮崎県", en: "Miyazaki", capital: "宮崎市", lat: 31.9111, lng: 131.4239, admin1: "25" },
  { jis: "46", name: "鹿児島県", en: "Kagoshima", capital: "鹿児島市", lat: 31.5602, lng: 130.5581, admin1: "18" },
  { jis: "47", name: "沖縄県", en: "Okinawa", capital: "那覇市", lat: 26.2124, lng: 127.6809, admin1: "47" },
];
...
function addPrefectures(result: Gazetteer, prefectures: readonly Prefecture[]): void {
  for (const pref of prefectures) {
    ...
    addAlias(result.aliases, id, pref.name.replace(/県$/u, "县"), "zh", 20);
...
function addCapitalAlias(result: Gazetteer, pref: Prefecture): void {
  ...
  const bare = pref.capital.replace(/市$/u, "");
  addAlias(result.aliases, capital.id, bare, "ja", priority[capital.kind]);
  addAlias(result.aliases, capital.id, `${bare}市`, "ja", priority[capital.kind]);
}
...
function options(argv: string[]): Record<string, string> {
  ...
  for (let index = 0; index < argv.length; index += 2) {
    ...
    if (!key || !value) throw new Error("Usage: --stations <path> --cities <path> --out-sql <path> --out-audit <path>");
    result[key] = value;
  }
  return result;
}

function requiredOptions(args: Record<string, string>): CliOptions {
  const { stations, cities, "out-sql": outSql, "out-audit": outAudit } = args;
  if (!stations || !cities || !outSql || !outAudit) throw new Error("missing required gazetteer generator option");
  return { stations, cities, outSql, outAudit };
}
...
async function main(): Promise<void> {
  ...
  const [stationText, cityText, namesText] = await Promise.all([readFile(resolve(args.stations), "utf8"), readFile(resolve(args.cities), "utf8"), readFile(namesPath, "utf8")]);
  ...
  const command = `node --import tsx workers/catalog/scripts/build-gazetteer.ts --stations ${args.stations} --cities ${args.cities} --out-sql ${args.outSql} --out-audit ${args.outAudit}`;
  await Promise.all([publish(args.outSql, renderSql(gazetteer, { stationSha: sha256(stationText), citiesSha: sha256(cityText), command })), publish(args.outAudit, renderAudit(gazetteer))]);
}
