  ...
  return (
    <div className="min-h-screen bg-background font-sans">
      ...
      <main className="mx-auto max-w-[960px] px-5 py-10 sm:px-8 sm:py-16">
        ...
        {query && (
          <div className="entrance-up-fast mb-10">
        ...
        {status === "loading" && (
          <div className="flex items-center gap-3 py-16 text-base text-muted-foreground">
            <span className="spin-loading inline-block h-4 w-4 rounded-full border-2 border-primary border-t-transparent" />
            {t.loading}
          </div>
        )}
        ...
        {status === "done" && rows.length > 0 && total > rows.length && (
          <div className="mt-10 rounded-xl border border-border bg-card p-8 text-center">
            <p className="text-base text-muted-foreground">{t.login_for_more}</p>
            <Link
              href="/?login=true"
        ...
        {!query && (
          <div className="py-16 text-center">
            <p className="text-lg font-medium text-foreground">{t.no_results_hint}</p>
            <Link href="/" className="mt-4 inline-block text-sm text-primary hover:underline">
              {t.back_to_home}
            </Link>
          </div>
