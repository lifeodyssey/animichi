...
export default function ResultAnchor({
  ...
  return (
    ...
    >
      <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-primary text-sm text-primary-fg">
        {"\uD83D\uDCCD"}
      </span>
      ...
      <span className="shrink-0 text-sm text-muted-foreground transition-transform group-hover/anchor:translate-x-0.5" style={{ transitionDuration: "var(--duration-fast)" }}>
        {"\u203A"}
      </span>
    </button>
  );
