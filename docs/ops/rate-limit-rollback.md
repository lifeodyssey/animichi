...
| Daily quota | $EDGE_GUARD budget latch + native admission (`daily_usage` / `anon_daily_message_count`) | anonymous daily cost/message ceilings | early budget lockout (403 `anon_budget_exhausted`) |
