...
Developers and fixers run GLM or DeepSeek (owner roster, 2026-09-24); the coordinator
is this session. GLM and DeepSeek review each other's candidates; a candidate both
wrote is reviewed by Kimi. Do not silently lower effort.
