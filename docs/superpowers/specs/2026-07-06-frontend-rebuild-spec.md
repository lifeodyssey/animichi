...
| 2 | Follow-through: details + list | 9 | Fully detailed | Route details v2 + the マイルート (My Route) bookshelf view + the save/list enabler (`workers/users` oRPC + Neon) + sessions data migration; the anime page's fact ledger (SD-15) fields accumulate alongside chat |
