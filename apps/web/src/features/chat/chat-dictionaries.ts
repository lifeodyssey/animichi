...
const ja: ChatDict = {
  ...
  newJourney: "新しい旅",
  recentLabel: "最近",
  sidebarGuestHint: "ログインすると、前の旅がここに並ぶよ",
  crumbJourneys: "私の旅",
...
const zh: ChatDict = {
  ...
  newJourney: "新的旅程",
  recentLabel: "最近",
  sidebarGuestHint: "登录后，之前的旅程会列在这里",
  crumbJourneys: "我的旅程",
...
const en: ChatDict = {
  ...
  recentLabel: "Recent",
  sidebarGuestHint: "Log in and your past journeys will line up here",
  ...
  entryChatTitle: "Talk it through first",
