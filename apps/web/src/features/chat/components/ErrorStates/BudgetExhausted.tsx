...
const LOGIN = chatActionClass({ tone: "gold", className: "chat-budget-exhausted__login [padding:9px_16px]!" });
const DISCLOSURE = chatActionClass({ className: "chat-budget-exhausted__byok [padding:9px_4px]! [font-weight:500]! [--animal-text-color:var(--color-muted-fg)]" });
