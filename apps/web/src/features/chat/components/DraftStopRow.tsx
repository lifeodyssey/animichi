...
function StopSummary(props: StopProps & Readonly<{ contentId: string }>) {
  ...
  return <div className="flex items-center gap-2 @min-[25rem]/draft:gap-3"><StopNumber index={props.index} /><div className="shrink-0"><StopImage place={stop.place} dict={dict} /></div>
