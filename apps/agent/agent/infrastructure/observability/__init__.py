...
Usage:
    from agent.infrastructure.observability import get_tracer, setup_tracing
...
from agent.infrastructure.observability.metrics import (
    get_meter,
    setup_metrics,
    shutdown_metrics,
)
...
from agent.infrastructure.observability.tracing import (
    get_tracer,
    setup_tracing,
    shutdown_tracing,
)
