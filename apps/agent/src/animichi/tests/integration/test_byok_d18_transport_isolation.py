...
from animichi.agents.byok_models import ByokCredential, build_byok_model
...
async def test_end_to_end_transport_isolation_between_main_loop_and_helper() -> None:
    ...
    try:
        ...
        # `public_api` does `from animichi.agents.base import resolve_model`, so a
        # patch on `animichi.agents.translation.resolve_model` misses entirely and
