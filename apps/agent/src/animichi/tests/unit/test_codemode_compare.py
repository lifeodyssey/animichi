...
from animichi.spikes.codemode import compare as compare_module
from animichi.spikes.codemode.report import CaseMeasurement, RematchReport
...
def test_compare_stays_json_reader_only() -> None:
    ...
    assert "animichi.agents" not in source
