...
def test_geocode_types_remain_reexported() -> None:
    assert GeocodeCandidate.__module__ == "animichi.clients.geocode"
    assert GeocodeKind.__module__ == "animichi.clients.geocode"
    assert GeocodeSource.__module__ == "animichi.clients.geocode"
