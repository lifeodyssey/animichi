...
from animichi.agents.animichi_agent import build_animichi_agent
from animichi.agents.runtime_deps import RuntimeDeps, TitleTranslator, WebSearcher
...
from animichi.tests.eval.mock_web import MockWebSearcher
...
async def test_run_error_hook_records_then_sd18_boundary_converts_it(
    ...
    monkeypatch.setattr(
        "animichi.agents.animichi_agent.record_agent_run_error", recorded.append
    )
