...
from animichi.agents.catalog_tools import run_resolve
from animichi.agents.runtime_deps import RuntimeDeps
from animichi.agents.tool_outcomes import ResolveNotFound
from animichi.agents.translation import TranslationResult, translate_title
...
async def test_place_name_translation_never_uses_anime_retrieval() -> None:
    ...
    with patch("animichi.agents.translation.translation_agent", translator):
