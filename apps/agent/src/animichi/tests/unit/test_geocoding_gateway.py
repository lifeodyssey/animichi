...
import animichi.infrastructure.gateways.geocoding as geocoding
from animichi.infrastructure.gateways.geocoding import (
    GeocodingCandidate,
...
def _install_httpx(
    ...
    *,
    ...
    monkeypatch.setattr(
        "animichi.infrastructure.gateways.geocoding.httpx.AsyncClient", constructor
    )
