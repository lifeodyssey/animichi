...
from animichi.agents.selection import execute_multi_selection
from animichi.clients.catalog_client import SearchResult
from animichi.interfaces.response_builder import agent_result_to_response
from animichi.tests.unit.test_phase1c_selection_handlers import (
    _Catalog,
    _pending,
    _point,
)
