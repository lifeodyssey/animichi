...
from animichi.agents.web_trust import WebResult
from animichi.tests.eval.mock_catalog_client import (
    FIXTURE_POINTS,
    LOCATION_CENTERS,
    TITLE_ALIASES,
    TITLE_NAMES,
)
from animichi.tests.eval.mock_catalog_fixtures import TitleNames
