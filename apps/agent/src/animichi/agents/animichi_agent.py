...
from animichi.agents.history_compaction import native_history_compaction
...
from animichi.agents.tool_outcomes import ResolveAmbiguous, ResolveNotFound
from animichi.agents.web_tools import TOOLS as WEB_TOOLS
from animichi.domain.compaction_retention import RetainedEntityLedger
from animichi.domain.fact_ledger import FactLedger
from animichi.infrastructure.observability import record_agent_run_error
from animichi.utils.language import locale_name, resolve_reply_language
...
def _validate_clarify(output: ClarifyResponseModel, pending: object) -> None:
    from animichi.agents.session_state import PendingClarification
