...
_meter_provider: _Shutdownable | None = None
...
def setup_metrics(
    ...
    **exporter_kwargs: object,
    ...
    try:
        ...
        from backend.infrastructure.observability.exporters import (
    ...
    if exporter_type != "none":
        ...
        if exporter is not None:
            ...
            readers.append(
                PeriodicExportingMetricReader(cast(MetricExporter, exporter))
            )
...
def get_meter(name: str) -> _NoOpMeter:
    ...
    try:
        ...
        return cast(_NoOpMeter, metrics.get_meter(name))
    except ImportError:
        return _NoOpMeter()
