...
Design tokens:
- Background: `#0f0f11` (深夜黑 — deep night black)
- Foreground: `#f0ece6` (和紙白 — washi white)
- Primary accent: `#d4954a` (琥珀橙 — amber orange, restrained)
...
leads with the display font for headings and anime titles. The amber accent appears
sparingly — buttons, active states, anchor cards — never as a background fill.

Avoid: generic purple gradients, white card stacks, "AI chat assistant" aesthetics.
