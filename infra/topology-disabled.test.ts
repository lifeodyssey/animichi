...
test("no R2 custom domain is declared, so every bucket stays private", () => {
  ...
  // of the four buckets (catalog-media, map-tiles, docs-assets,
  // catalog-snapshots) may get one, or catalog or documentation data would
  // leak without going through the edge Worker.
