...
from infrastructure.observability.metrics import get_meter
...
def _get_runtime_instruments() -> tuple[Any, Any]:
    global _runtime_request_counter, _runtime_request_duration
...
def _get_http_instruments() -> tuple[Any, Any]:
    global _http_request_counter, _http_request_duration
