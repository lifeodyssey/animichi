...
queue_source_red_probe("canonical title validator removed", queue_source.sub('python3 "$TITLE_GATE" --subject "$title"', "true"))
queue_source_red_probe("queue title validation removed", queue_source.sub('validate_squash_title "$1" "$pr"', 'true # title validation removed'))
queue_source_red_probe("PR title validation removed", queue_source.sub('validate_squash_title "$1" "$3"', 'true # title validation removed'))
