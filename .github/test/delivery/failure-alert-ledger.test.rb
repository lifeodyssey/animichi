# SUT: .github/scripts/alert/failure-alert.rb's ledger scan — how the alerter
# finds its ledger (#678 AC1): over the open issues' own bodies, with no label
# the repository has to configure first, across pages, and failing loudly rather
# than deduplicating against a ledger it could not read.
