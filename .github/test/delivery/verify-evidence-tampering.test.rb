# SUT: .github/scripts/release/verify-evidence.mjs against tampered evidence — the
# two mutations that make the deploy-evidence mechanism proven rather than merely
# green: a published receipt that does not match what was deployed, and a
# credential-shaped value in the artifact (#1695).
#
