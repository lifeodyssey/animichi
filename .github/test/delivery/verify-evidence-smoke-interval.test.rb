# SUT: .github/scripts/release/verify-evidence.mjs — #1596 AC5's container-absent
# requirement, judged over the smoke interval (#1713). The smoke runs before the
# recorder, so the recorder's own container read says nothing about the state the
# smoke passed in: the deploy lane also reads the container applications before the
# smoke, and the verifier holds the criterion to both reads.
