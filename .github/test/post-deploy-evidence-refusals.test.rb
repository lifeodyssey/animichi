# SUT: the recorder's refusals (#1695 requirement 2) — the credentials this lane
# must never hold, the origin a service token must never reach, and the origin
# spelling held to the contract module it mirrors.
