# SUT: who a published alert reaches (#1718 AC2) — the assignment that turns an
# issue nobody is watching into a notification, where that name comes from, and the
# refusal that keeps a dropped audience from reading as coverage. The dedup
# identity, the ledger and the permissions are #678's contracts and keep their own
# counts; this file asserts the audience only.
